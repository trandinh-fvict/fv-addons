...
class IrHttp(models.AbstractModel):
    ...
    def session_info(self):
        ...
        information about whether an appsbar image is available.
        ...
        associated companies. For each company, it checks for the presence of an
        appbar image and adds a corresponding boolean flag to the company's data.
        Returns:
            dict: The extended session information, including the
                  'has_appsbar_image' flag for each company.
        """
